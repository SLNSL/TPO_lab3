...
public class PickHotelRoom {
  ...
  public void test() {
    ...
    assertEquals(driver.findElement(By.xpath("//*[@id=\"checkoutForm\"]/div[2]/div[1]/div/div/div[4]/div[1]/div/div[1]/div/div[3]/div[2]")).getText().substring(0, 25), "Оплатить полную стоимость");
